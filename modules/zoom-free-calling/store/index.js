...
import { api } from "./api";
export const getOauthToken = createAsyncThunk("zoom/getOauthToken", async (payload, {
  rejectWithValue
}) => {
  try {
...
export const getCurrentUser = createAsyncThunk("zoom/getCurrentUser", async (payload, {
  rejectWithValue
}) => {
  try {
...
export const createMeeting = createAsyncThunk("zoom/createMeeting", async (payload, {
  rejectWithValue
}) => {
  try {
...
export const getMeetingList = createAsyncThunk("zoom/getMeetingList", async (payload, {
  rejectWithValue
}) => {
  try {
...
export const slice = createSlice({
  ...
  extraReducers: builder => {
    builder.addCase(getOauthToken.pending, state => {
